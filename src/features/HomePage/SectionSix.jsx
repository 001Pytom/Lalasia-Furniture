    ...
    <div className="my-10 py-10 flex gap-10 w-full  justify-between">
      <div className="space-y-8 ">
        ...
        <div className="max-w-[582px] w-full relative ">
          <Image src={articleOne} alt="articleOne" className="" />
          <div className="w-[530px] space-y-[14px]  absolute bottom-10 left-10">
            <p className="text-neutral-background font-medium  text-lg opacity-[70%]">
              Tips and Trick
            </p>
            <div className="space-y-2">
              <h3 className="font-bold text-neutral-background text-[26px] tracking-[1%] font-sans">
                Create Cozy Dinning Room Vibes
              </h3>
              <p className="truncate font-medium text-lg text-neutral-background opacity-[70%]">
            ...
            <div>
              <Link to="/articles" className="text-lg text-neutral-background">
                Read More
              </Link>
            </div>
          </div>
